...
export default defineNuxtConfig({
    ...
    primevue: {
        ...
        components: {
            prefix: 'Prime',
            include: [
                'Calendar', 'Checkbox', 'Dropdown', 'InputGroup', 'InputText', 'InputNumber', 'InputMask', 'MultiSelect',
                'Password', 'RadioButton', 'SelectButton', 'Textarea', 'Button', 'ToggleButton', 'SplitButton',
                'DataTable', 'Column', 'ColumnGroup', 'Row', 'Divider', 'ScrollPanel', 'IconField', 'InputIcon',
                'TabView', 'TabPanel', 'ConfirmDialog', 'ConfirmationService', 'OverlayPanel',
                'Dialog', 'DynamicDialog', 'DialogService', 'ContextMenu', 'Menu', 'MenuItem', 'MenuItemCommandEvent', 'TabMenu',
                'Message', 'InlineMessage', 'Toast', 'ToastService', 'Image', 'Avatar', 'Badge',
                'BlockUI', 'Inplace', 'Skeleton', 'ProgressBar', 'ProgressSpinner', 'Tag', 'InputSwitch'
            ]
        },
        directives: {
            prefix: 'Prime',
            include: ['Ripple', 'Tooltip', 'FocusTrap', 'Badge', 'StyleClass']    /* Used as v-pripple and v-ptooltip */
        }
    },
